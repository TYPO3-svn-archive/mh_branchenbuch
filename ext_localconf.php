...
// RealURL-AutoConf
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['ext/realurl/class.tx_realurl_autoconfgen.php']['extensionConfiguration'][$_EXTKEY] = 'EXT:mh_branchenbuch/lib/class.tx_mhbranchenbuch_realurl.php:tx_mhbranchenbuch_realurl->getConfig';
